...
const AUTH_PATH_RE = /^\/(en|es|uk|ru|ar|sq)\/(sign-in|sign-up|forgot-password|reset-password|set-password)(\/|$)/;
const MAINTENANCE_PATH_RE = /^\/(en|es|uk|ru|ar|sq)\/maintenance(\/|$)/;
