    ...
    <div className="flex flex-wrap gap-1 pt-0.5">
      {visible.map((item, i) => (
        <span
          ...
          className="inline-flex max-w-full items-center rounded-md border border-emerald-500/15 bg-emerald-500/[0.06] px-1.5 py-0.5 text-[10px] font-medium leading-snug text-foreground/80 dark:border-emerald-400/15 dark:bg-emerald-400/[0.07]"
        >
