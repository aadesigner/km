  ...
  return (
    <section
      className={cn(
        ...
        "-mt-[var(--site-header-offset,76px)] pt-[calc(0.5rem+var(--site-header-offset,76px))] sm:pt-[calc(1.25rem+var(--site-header-offset,76px))]",
      )}
    >
      ...
      <EnterReveal y={16} className={cn("w-full max-w-[420px] md:max-w-[480px]", className)}>
        <div
          className={cn(
            "relative overflow-hidden rounded-3xl",
            "border border-border/70 bg-card/95 md:backdrop-blur-md",
