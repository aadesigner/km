        ...
        >
          <div
            className={cn(
              ...
              flooded ? "bg-red-100 dark:bg-red-900/40" : "bg-green-100 dark:bg-green-900/40",
            )}
          >
            {flooded
          ...
          <div className="min-w-0">
            ...
            <p
              className={cn(
                ...
                flooded ? "text-red-700 dark:text-red-400" : "text-green-700 dark:text-green-400",
              )}
            >
