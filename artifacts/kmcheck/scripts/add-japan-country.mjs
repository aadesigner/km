 ...
 * Run: node artifacts/kmcheck/scripts/add-japan-country.mjs
 */
import fs from "fs";
...
LOCALE.fr = {
  ...
  compare_desc_japan:
    "Les outils Japon-only manquent l'historique d'export. kmcheck couvre le Japon, la Corée, les USA et plus dans un rapport.",
...
LOCALE.sq = cloneFromEnWithOverrides({
  ...
  compare_desc_japan:
    "Mjetet vetëm për Japoninë humbasin historinë e eksportit. kmcheck mbulon makina japoneze, Kore, SHBA dhe më shumë në një raport.",
});
...
LOCALE.pl = cloneFromEnWithOverrides({
  ...
  compare_desc_japan:
    "Narzędzia tylko dla Japonii pomijają historię eksportu. kmcheck obejmuje Japonię, Koreę, USA i więcej w jednym raporcie.",
});
...
LOCALE.bg = cloneFromEnWithOverrides({
  ...
  compare_desc_japan:
    "Инструментите само за Япония пропускат експортната история. kmcheck покрива Япония, Корея, САЩ и още в един доклад.",
});
...
LOCALE.ar = cloneFromEnWithOverrides({
  ...
  compare_desc_japan:
    "أدوات اليابان فقط تفوّت سجل التصدير. يغطي kmcheck اليابان وكوريا والولايات المتحدة والمزيد في تقرير واحد.",
});
...
LOCALE.uk = cloneFromEnWithOverrides({
  ...
  compare_desc_japan:
    "Інструменти лише для Японії пропускають історію експорту. kmcheck охоплює Японію, Корею, США та більше в одному звіті.",
});
...
LOCALE.zh = cloneFromEnWithOverrides({
  ...
  compare_desc_japan:
    "仅限日本的工具会漏掉出口与跨境历史。kmcheck 一份报告覆盖日本、韩国、美国及更多市场。",
});
...
if (!seo.country_japan) {
  seo.country_japan = {
    ...
    de: {
      title: "Japan-Kilometercheck — Japanische Autos | kmcheck.com",
      description:
    ...
    es: {
      title: "Chequeo kilometraje Japón — coches japoneses | kmcheck.com",
      description:
    ...
    fr: {
      title: "Contrôle kilométrique Japon — voitures japonaises | kmcheck.com",
      description:
    ...
    sq: {
      title: "Kontroll kilometrash Japoni — makina japoneze | kmcheck.com",
      description:
    ...
    pl: {
      title: "Sprawdzenie przebiegu Japonia — auta japońskie | kmcheck.com",
      description:
    ...
    ro: {
      title: "Verificare kilometraj Japonia — mașini japoneze | kmcheck.com",
      description:
    ...
    bg: {
      title: "Проверка на километраж Япония — японски коли | kmcheck.com",
      description:
    ...
    ar: {
      title: "فحص كيلومترات اليابان — سيارات يابانية | kmcheck.com",
      description:
