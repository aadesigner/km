 ...
 * Run: node artifacts/kmcheck/scripts/fix-japan-authentic-i18n.mjs
 */
import fs from "fs";
...
const JP = {
  en: {
    ...
    compare_desc_japan:
      "Japan-only tools miss export and cross-border history. kmcheck covers Japanese vehicles, Korea, USA, and more in one report.",
  ...
  sq: {
    ...
    compare_desc_japan:
      "Mjetet vetëm për Japoninë humbasin historinë e eksportit. kmcheck mbulon Japoninë, Koreën, SHBA dhe më shumë në një raport.",
  ...
  de: {
    ...
    compare_desc_japan:
      "Nur-Japan-Tools fehlen Export- und Grenzdaten. kmcheck deckt japanische Fahrzeuge, Korea, USA und mehr in einem Bericht ab.",
    demo_card_origin_japan: "Japan",
  ...
  es: {
    ...
    compare_desc_japan:
      "Las herramientas solo Japón omiten historial de exportación. kmcheck cubre vehículos japoneses, Corea, EE. UU. y más en un informe.",
  ...
  fr: {
    ...
    compare_desc_japan:
      "Les outils Japon seuls manquent l'historique d'export. kmcheck couvre le Japon, la Corée, les USA et plus dans un rapport.",
  ...
  pl: {
    ...
    compare_desc_japan:
      "Narzędzia tylko-Japonia pomijają historię eksportu. kmcheck obejmuje Japonię, Koreę, USA i więcej w jednym raporcie.",
    demo_card_origin_japan: "Japonia",
  ...
  ro: {
    ...
    compare_desc_japan:
      "Instrumentele doar-Japonia ratează istoricul de export. kmcheck acoperă Japonia, Coreea, SUA și mai mult într-un raport.",
    demo_card_origin_japan: "Japonia",
  ...
  bg: {
    ...
    compare_desc_japan:
      "Инструментите само за Япония пропускат експортната история. kmcheck покрива Япония, Корея, САЩ и повече в един доклад.",
  ...
  ka: {
    ...
    compare_desc_japan:
      "მხოლოდ-იაპონიის ხელსაწყოებს აკლია ექსპორტის ისტორია. kmcheck ფარავს იაპონიას, კორეას, აშშ-ს და მეტს ერთ ანგარიშში.",
  ...
  ar: {
    ...
    compare_desc_japan:
      "أدوات اليابان فقط تفوّت سجل التصدير. kmcheck يغطي اليابان وكوريا والولايات المتحدة والمزيد في تقرير واحد.",
  ...
  uk: {
    ...
    compare_desc_japan:
      "Інструменти лише для Японії пропускають історію експорту. kmcheck покриває Японію, Корею, США та більше в одному звіті.",
  ...
  ru: {
    ...
    footer_japan_link_4: "История Toyota Honda Nissan",
    compare_desc_japan:
      "Инструменты только для Японии пропускают историю экспорта. kmcheck покрывает Японию, Корею, США и больше в одном отчёте.",
    demo_card_origin_japan: "Япония",
  ...
  zh: {
    ...
    compare_desc_japan: "仅限日本的工具会漏掉出口与跨境历史。kmcheck 一份报告覆盖日本、韩国、美国及更多市场。",
...
const SEO_JP = {
  en: {
    title: "Japan Mileage Check — Japanese Cars | kmcheck.com",
    description:
  ...
  de: {
    title: "Japan-Kilometercheck — Autos aus Japan | kmcheck.com",
    description:
  ...
  es: {
    title: "Chequeo kilometraje Japón — coches de Japón | kmcheck.com",
    description:
  ...
  fr: {
    title: "Contrôle kilométrique Japon — voitures du Japon | kmcheck.com",
    description:
  ...
  sq: {
    title: "Kontroll kilometrash Japoni — makina nga Japonia | kmcheck.com",
    description:
  ...
  pl: {
    title: "Sprawdzenie przebiegu Japonia — auta z Japonii | kmcheck.com",
    description:
  ...
  ka: {
    title: "იაპონური მანქანები — გარბენი და ისტორია | kmcheck.com",
    description:
  ...
  ro: {
    title: "Verificare kilometraj Japonia — mașini din Japonia | kmcheck.com",
    description:
  ...
  bg: {
    title: "Проверка на пробег Япония — автомобили от Япония | kmcheck.com",
    description:
